...
## Smoke-проверка (автотест роутов)

Одна команда прогоняет все 18 роутов приложения в headless-браузере и падает, если
хоть один экран не открылся или дал ошибку консоли.
...
```sh
# Сервер запустится автоматически (порт 8080):
