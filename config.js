...
// --- Версия кэша ассетов ---
// ЕДИНСТВЕННАЯ точка смены cache-bust суффикса ?v=v1.9
//   index.html  <link href="styles.css?v=v1.9">  и  <script src="main.js?v=v1.9">
//   main.js     import '…/appRoutes.js?v=v1.9'
//   core/appRoutes.js  import '…/TasksView.js?v=v1.9'
//
...
export const APP_CACHE_VERSION = 'v1.9';
