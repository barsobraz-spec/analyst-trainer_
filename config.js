...
// --- Версия кэша ассетов ---
// ЕДИНСТВЕННАЯ точка смены cache-bust суффикса ?v=v1.5
//   index.html  <link href="styles.css?v=v1.5">  и  <script src="main.js?v=v1.5">
//   main.js     import '…/appRoutes.js?v=v1.5'
//   core/appRoutes.js  import '…/TasksView.js?v=v1.5'
//
...
export const APP_CACHE_VERSION = 'v1.5';
