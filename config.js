...
// --- Версия кэша ассетов ---
// ЕДИНСТВЕННАЯ точка смены cache-bust суффикса ?v=v1.8
//   index.html  <link href="styles.css?v=v1.8">  и  <script src="main.js?v=v1.8">
//   main.js     import '…/appRoutes.js?v=v1.8'
//   core/appRoutes.js  import '…/TasksView.js?v=v1.8'
//
...
export const APP_CACHE_VERSION = 'v1.8';
